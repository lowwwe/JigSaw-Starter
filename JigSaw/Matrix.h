...
struct MyMatrix
{
	...
	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	static MyMatrix rotationAntiClockwiseX(float t_angleDegrees);
	static MyMatrix rotationAntiClockwiseY(float t_angleDegrees);
	static MyMatrix rotationAntiClockwiseZ(float t_angleDegrees);
	...
	static MyMatrix translationXY(const MyVector3 t_displacement); // 2d translation make sure z=1
